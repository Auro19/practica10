...
void display ( void )   // Creamos la funcion donde se dibuja
{
	...
	glTranslatef(pos_camX, pos_camY, pos_camZ);
		...
		glPushMatrix(); 
			...
			prisma(t_Ajedrez2.GLindex, t_lava.GLindex);
		glPopMatrix();
		//mesa
		glPushMatrix();
			glColor3f(1.0, 1.0, 1.0);
		...
		glPushMatrix();
			glColor3f(1.0, 1.0, 1.0);
			glTranslatef(1.125, -1.8, 1.125);
			glScalef(0.25f, 3.0, 0.25f);
			prisma(t_madera.GLindex, t_madera.GLindex);
		glPopMatrix();
		glPushMatrix();
			glColor3f(1.0, 1.0, 1.0);
		...
		glPushMatrix();
			...
			glPushMatrix();
				glColor3f(1.0, 1.0, 1.0);
				glTranslatef(0.40, -2.5, 0.40);
				glScalef(0.20f, 4.0, 0.20f);
				prisma(t_madera.GLindex, t_madera.GLindex);
			glPopMatrix();
			glPushMatrix();
				glColor3f(1.0, 1.0, 1.0);
				glTranslatef(0.40, 3.5, 0.40);
				glScalef(0.20f, 6.0, 0.20f);
				prisma(t_madera.GLindex, t_madera.GLindex);
			glPopMatrix();
			glPushMatrix();
				glColor3f(1.0, 1.0, 1.0);
			...
			glPushMatrix();
				glColor3f(1.0, 1.0, 1.0);
				glTranslatef(0.4, 5.0, 0.0);
				glScalef(0.20, 1.0, 1.0);
				prisma(t_madera.GLindex, t_madera.GLindex);
			glPopMatrix();
		glPopMatrix();
	glPopMatrix();
